...
const TargetCursor = ({
  targetSelector = '.editor-sidebar .cursor-pointer, .editor-sidebar button, .editor-sidebar input, .editor-sidebar textarea, .editor-sidebar .search-item, .editor-sidebar .git-item, .editor-sidebar .extension-card',
  spinDuration = 2,
  hoverDuration = 0.2,
  parallaxOn = true,
  cursorColor = '#ffffff',
  ...
  useEffect(() => {
    ...
    sidebar.addEventListener('mouseup', mouseUpHandler);

    // Fade cursor in when entering sidebar, out when leaving
    ...
    sidebar.addEventListener('mouseover', enterHandler, { passive: true });
    ...
    return () => {
      ...
      sidebar.removeEventListener('mouseover', enterHandler);
      sidebar.removeEventListener('mousedown', mouseDownHandler);
      sidebar.removeEventListener('mouseup', mouseUpHandler);
